    ...
    return (
        ...
        <div className="mainContentDiv">
            ...
            <p>
                ...
                You can find some games and other projects I made on the "Projects" page.<br/>
                Also, I am a passionate boogie-woogie dancer. I might post some news about shows or tournaments I participate in here.<br/>
